...
class DiningBookingBloc extends Bloc<DiningBookingEvent, DiningBookingState> {
  final BookingRepository bookingRepository;

  DiningBookingBloc({required this.bookingRepository}) : super(LoadingBooking());

  @override
  Stream<DiningBookingState> mapEventToState(DiningBookingEvent event) async* {
